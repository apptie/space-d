...
INSERT INTO pronunciations(id, created_at, updated_at, content, pronunciation_type, word_id)
VALUES(1, now(), now(), '어써라이제이션', 'KOREAN', 1);
INSERT INTO word_examples(id, created_at, updated_at, content, word_id)
