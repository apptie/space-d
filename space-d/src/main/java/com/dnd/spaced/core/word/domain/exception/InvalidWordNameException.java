...
public class InvalidWordNameException extends WordClientException {

    public InvalidWordNameException(String message) {
        super(WordErrorCode.INVALID_WORD_NAME, message);
    }
}
