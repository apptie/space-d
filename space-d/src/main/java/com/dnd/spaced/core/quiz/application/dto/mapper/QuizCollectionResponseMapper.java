...
@Mapper
public class QuizCollectionResponseMapper {

    public QuizCollectionResponse toCollectionResponse(List<SimpleQuizDto> quizzes) {
    ...
    private QuizResponse toQuizResponse(SimpleQuizDto quiz) {
    ...
    private List<QuizQuestionResponse> toQuizQuestionResponse(List<QuizQuestionDto> quizQuestions) {
